...
/**
 * Primary Key class for StockTx.
 */
public class StockTxPK implements java.io.Serializable
{
	public int trans_id;
	...
	{
		if (other != null && other instanceof StockTxPK)
			return ((StockTxPK)other).trans_id == this.trans_id;
		else
			return false;
	}
}
