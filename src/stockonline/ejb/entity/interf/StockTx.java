...
/**
 * These are the business logic methods exposed publicly by StockTxBean.
 */
public interface StockTx extends EJBObject
{
	/**
	 * Get transaction ID
	 */
	public int getTxID() throws RemoteException;
}
