...
//		25/09/2001	Shiping	Deprecated the findByCode 
//
//
 ...
 */
public interface StockItemHome extends EJBHome
{
	public StockItem create() throws CreateException, RemoteException;

	/**
	 * Finds an Account by its primary Key (Account ID)
	 */
	public StockItem findByPrimaryKey(StockItemPK key) throws FinderException, RemoteException;

	/**
	 * Finds an Account by its code
	 */
	// public StockItem findByCode(String stockCode) throws FinderException, RemoteException;
}
