 ...
 */
public interface StockHoldingHome extends EJBHome
{
	/**
	 * Creates the EJB Object.
	 */
	public StockHolding create(int sub_accno, int stock_id, int amount) throws CreateException, RemoteException;

	/**
	 * Finds an StockHolding by its primary Key
	 */
	public StockHolding findByPrimaryKey(StockHoldingPK key) throws FinderException, RemoteException;

	/**
	 * Finds StockHolding's by accountID
	 */
	public Collection findByAccountID(int accountID, int start_stockID) throws FinderException, RemoteException;
}
