...
/**
 * Primary Key class for StockHolding.
 */
public class StockHoldingPK implements java.io.Serializable
{
	public int sub_accno;
	public int stock_id;

	public StockHoldingPK() {}

	public StockHoldingPK(int sub_accno, int stock_id)
	{
	...
	public int hashCode()
	{
		return sub_accno ^ stock_id;
	}

	public boolean equals(Object other)
	{
		if (other != null && other instanceof StockHoldingPK)
			return ((StockHoldingPK)other).sub_accno == this.sub_accno &&
				   ((StockHoldingPK)other).stock_id  == this.stock_id;
		else
			return false;
	}
}
