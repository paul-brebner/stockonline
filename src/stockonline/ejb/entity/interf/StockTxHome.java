...
/**
 * This is the home interface for StockTx.
 */
public interface StockTxHome extends EJBHome
{
	/**
	 * This method creates the EJB Object.
	 */
	public StockTx create(String trans_type, int sub_accno, int stock_id, int amount, float price) throws CreateException, RemoteException;

	/**
	 * This method creates the EJB Object.
	 */
	public StockTx create(int trans_id, String trans_type, int sub_accno, int stock_id, int amount, float price) throws CreateException, RemoteException;

	/**
	 * Finds a StockTx by its primary Key
	 */
	public StockTx findByPrimaryKey(StockTxPK key) throws FinderException, RemoteException;
}
